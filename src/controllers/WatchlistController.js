class WatchlistController {
  constructor(watchlistService) {
    ...
    async getWatchlistById(req, res) {
        ...
        try {
            const item = await this.watchlistService.getWatchlistById(movieId, userId);
    ...
    async addToWatchlist(req, res) {
        ...
        const movieId = req.params.id;
        try {
            const newItem = await this.watchlistService.addToWatchlist(movieId, userId);
    ...
    async isInWatchlist(req, res) {
        ...
        const movieId = req.params.id;  
        try {
            const exists = await this.watchlistService.isInWatchlist(movieId, userId);
