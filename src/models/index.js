...
// Users ↔ Comments
User.hasMany(Comments, { foreignKey: 'userId', onDelete: 'CASCADE', onUpdate: 'CASCADE' })
Comments.belongsTo(User, { foreignKey: 'userId' })
Movie.hasMany(Comments, { foreignKey: 'movieId', onDelete: 'CASCADE', onUpdate: 'CASCADE' })
Comments.belongsTo(Movie, { foreignKey: 'movieId' })
...
export { sequelize, User, Movie, Rating, Favorite, Comments, WatchList }
